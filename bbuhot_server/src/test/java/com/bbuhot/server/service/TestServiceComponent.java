...
@Component(modules = {TestPersistenceModule.class, EntityModule.class,})
@Singleton
abstract class TestServiceComponent {

  static TestServiceComponent getInstance() {
    Configuration configuration = TestMessageUtil
        .getResourcesAsMessage(Configuration.getDefaultInstance(),
